...
class TestFormValidation(unittest.TestCase):
  def test_FormValidation(self):
    ...
    invName = self.driver.find_element(By.ID, "validationCustom01").get_attribute("class")
    print(invName)
    #self.assertTrue(invName, "Should have display invalid name message")
    self.driver.find_element(By.ID, "validationCustom01").click()
    self.driver.find_element(By.ID, "validationCustom01").send_keys("Sia Chong Perng")
    element = self.driver.find_element(By.ID, "validationCustom02")
    actions = ActionChains(self.driver)
    actions.move_to_element(element).click_and_hold().perform()
    invName2 = self.driver.find_element(By.ID, "invalidNameMsg").is_displayed()
    print(invName2)
    self.assertFalse(invName2, "Should have display invalid name message")
